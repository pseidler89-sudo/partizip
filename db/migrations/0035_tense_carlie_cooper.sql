...
ALTER TABLE "ki_pruefungen" ADD CONSTRAINT "ki_pruefungen_poll_id_polls_id_fk" FOREIGN KEY ("poll_id") REFERENCES "public"."polls"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
